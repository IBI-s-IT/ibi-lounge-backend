// noinspection XmlDeprecatedElement,HtmlDeprecatedAttribute,HtmlDeprecatedTag
...
export const customTimeDotReceived = [
  {
    date: '2023-06-20T21:00:00.000Z',
    lessons: [
      {
        text: 'ВычС,Сети и Тел',
        time_start: '2023-06-21T14:00:00.000Z',
        time_end: '2023-06-21T15:30:00.000Z',
        additional: {
          is_online: true,
          type: 'consultation',
          url: 'https://lms.ibispb.ru/mod/bigbluebuttonbn/view.php?id=26806',
          custom_time: {
            start: '2023-06-21T14:00:00.000Z',
            end: '2023-06-21T15:30:00.000Z',
          },
          location: 'Н-202-1',
          teacher_name: 'Ильина О.П.',
        },
      },
    ],
  },
  {
    ...
    lessons: [
      {
        text: 'Операц.сист.',
        time_start: '2023-06-22T09:50:00.000Z',
        time_end: '2023-06-22T11:20:00.000Z',
        additional: {
          is_online: true,
          type: 'consultation',
          url: 'https://lms.ibispb.ru/mod/bigbluebuttonbn/view.php?id=26537',
      ...
      {
        text: 'ВычС,Сети и Тел',
        time_start: '2023-06-22T12:00:00.000Z',
        time_end: '2023-06-22T13:30:00.000Z',
        additional: {
          is_online: true,
          type: 'exam',
          url: 'https://lms.ibispb.ru/mod/bigbluebuttonbn/view.php?id=26806',
...
export const compensationReceived = [
  {
    date: '2023-09-08T21:00:00.000Z',
    lessons: [
      {
        text: 'ИгрВидСпорт',
        time_start: '2023-09-09T06:00:00.000Z',
        time_end: '2023-09-09T07:30:00.000Z',
        additional: {
          is_online: true,
          type: 'practice',
          url: 'https://lms.ibispb.ru/mod/bigbluebuttonbn/view.php?id=23877',
      ...
      {
        text: 'ИгрВидСпорт',
        time_start: '2023-09-09T07:40:00.000Z',
        time_end: '2023-09-09T09:10:00.000Z',
        additional: {
          is_online: true,
          type: 'practice',
          url: 'https://lms.ibispb.ru/mod/bigbluebuttonbn/view.php?id=23877',
      ...
      {
        text: 'Макроэкономика',
        time_start: '2023-09-09T09:50:00.000Z',
        time_end: '2023-09-09T11:20:00.000Z',
        additional: {
          is_online: true,
          type: 'lecture',
          url: 'https://lms.ibispb.ru/mod/bigbluebuttonbn/view.php?id=20565',
          location: 'Н-202-1',
          teacher_name: 'Порядина И.В.',
        },
      },
      {
        text: 'ОснРосГосуд-ти',
        time_start: '2023-09-09T11:30:00.000Z',
        time_end: '2023-09-09T13:00:00.000Z',
        additional: {
          is_online: true,
          type: 'lecture',
          url: 'https://lms.ibispb.ru/mod/bigbluebuttonbn/view.php?id=28300',
          compensation: '13.09.23',
          location: 'Н-202-1',
          teacher_name: 'Батищева Н.А.',
        },
      },
    ],
  },
...
export const teachersHtml = `<center>
<h4>
Преподаватель Антипова Татьяна Борисовна<br>занятость за период с 01.01.2024 по 14.01.2024
</h4>
</center>
<table border=1 cellspacing=0 cellpadding=0 style='border-color: Black; border-collapse: collapse; background-color : #FFFFFF;'>
<tr align=center>
<td rowspan=2 style='border-color: Black;' bgcolor=#f6ecc8>
<b>Дата</b>
</td>
<td colspan=4 style='border-color: Black;' bgcolor=#f6ecc8>
<b>Время занятий</b>
</td>
</tr>
<td align=center style='border-color: Black;' bgcolor=#f6ecc8>
<b>9:00-10:30 &nbsp;</b>
</td>
<td align=center style='border-color: Black;' bgcolor=#f6ecc8>
<b>10:40-12:10 &nbsp;</b>
...
<td style='border-color: Black;'>10.01 Ср &nbsp;</td>
<td style='border-color: Black;'>&nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Конс, ауд.МС-34, гр.123-ПИвЭ,124-ИТвБ &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Конс, ауд.МС-34, гр.121,122 &nbsp;</td>
<td style='border-color: Black;'>&nbsp;</td>
</tr>
<tr style='background-color: #faf5e3' align=center>
<td style='border-color: Black;'>11.01 Чт &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Экз, ауд.МС-34, гр.121 &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Экз, ауд.МС-34, гр.121 &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Экз, ауд.МС-34, гр.122 &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Экз, ауд.МС-34, гр.122 &nbsp;</td>
</tr>
<tr style='background-color: transparent' align=center>
<td style='border-color: Black;'>12.01 Пт &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Экз, ауд.МС-34, гр.123-ПИвЭ &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Экз, ауд.МС-34, гр.123-ПИвЭ &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Экз, ауд.МС-34, гр.124-ИТвБ &nbsp;</td>
<td style='border-color: Black;'>ТеорВер.МатСтат, Экз, ауд.МС-34, гр.124-ИТвБ &nbsp;</td>
</tr>
</table>`;
export const teachersReceived = [
  {
    date: '2024-01-09T21:00:00.000Z',
    lessons: [
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-10T07:40:00.000Z',
        time_end: '2024-01-10T09:10:00.000Z',
        additional: {
          type: 'consultation',
          teacher_groups: ['123-ПИвЭ', '124-ИТвБ'],
          location: 'МС-34',
        },
      },
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-10T09:50:00.000Z',
        time_end: '2024-01-10T11:20:00.000Z',
        additional: {
          type: 'consultation',
          teacher_groups: ['121', '122'],
          location: 'МС-34',
        },
      },
    ],
  ...
  {
    date: '2024-01-10T21:00:00.000Z',
    lessons: [
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-11T06:00:00.000Z',
        time_end: '2024-01-11T07:30:00.000Z',
        additional: {
          type: 'exam',
          teacher_groups: ['121'],
          location: 'МС-34',
      ...
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-11T07:40:00.000Z',
        time_end: '2024-01-11T09:10:00.000Z',
        additional: {
          type: 'exam',
          teacher_groups: ['121'],
          location: 'МС-34',
      ...
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-11T09:50:00.000Z',
        time_end: '2024-01-11T11:20:00.000Z',
        additional: {
          type: 'exam',
          teacher_groups: ['122'],
          location: 'МС-34',
      ...
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-11T11:30:00.000Z',
        time_end: '2024-01-11T13:00:00.000Z',
        additional: {
          type: 'exam',
          teacher_groups: ['122'],
          location: 'МС-34',
  ...
  },
  {
    ...
    lessons: [
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-12T06:00:00.000Z',
        time_end: '2024-01-12T07:30:00.000Z',
        additional: {
          type: 'exam',
          teacher_groups: ['123-ПИвЭ'],
          location: 'МС-34',
        },
      },
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-12T07:40:00.000Z',
        time_end: '2024-01-12T09:10:00.000Z',
        additional: {
          type: 'exam',
          teacher_groups: ['123-ПИвЭ'],
          location: 'МС-34',
      ...
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-12T09:50:00.000Z',
        time_end: '2024-01-12T11:20:00.000Z',
        additional: {
          type: 'exam',
          teacher_groups: ['124-ИТвБ'],
          location: 'МС-34',
        },
      },
      {
        text: 'ТеорВер.МатСтат',
        time_start: '2024-01-12T11:30:00.000Z',
        time_end: '2024-01-12T13:00:00.000Z',
        additional: {
          type: 'exam',
          teacher_groups: ['124-ИТвБ'],
          location: 'МС-34',
