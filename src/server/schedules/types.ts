...
type SchedulesRequiredQuery = {
  dateStart: string;
  dateEnd: string;
}

type SchedulesStudentQuery = {
  group: string;
  subgroups?: string;
} & SchedulesRequiredQuery;

type SchedulesTeacherQuery = {
  teacher: string;
} & SchedulesRequiredQuery;

export type SchedulesQuery = SchedulesStudentQuery | SchedulesTeacherQuery;
